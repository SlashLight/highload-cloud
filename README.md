...
|------------------|--------|-------------|-----------------------|-------|----------|---------------|
| Authentification | 960    | 1920        | Легкое JSON API       |       |          |               |
| Authorization    | 960    | 1920        | Средняя бизнес-логика |       |          |               |
| Data             | 960    | 1920        | Тяжелая бизнес-логика |       |          |               |
| Metrics          | 960    | 1920        | Средняя бизнес-логика |       |          |               |
| URL Verifier     | 320    | 640         | Легкое JSON API       |       |          |               |
| User             | 100    | 200         | Средняя бизнес логика |       |          |               |
| Итого            | 51 521 | 103 043     | -                     |       |          |               |
