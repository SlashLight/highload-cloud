...
## Схема проекта
![Схема проекта](imgs/scheme.drawio.png)
#### Этап 1 - Балансировка
...
- **File Service** - сервис для управления пользовательскими файлами. Состоит из 3х микросервисов: **Controller**, **Authorization**, **Data**;
- **Controller** - входная точка в файловый сервис. Распределяет запросы между **Authorization** и **Data**;
